...
message.delete();
  ...
  if(!tomute) return message.reply("Doğru Kullanım: <"+prefix+">mute <kullanıcı> <süre> yada <"+prefix+">geçici-sustur <kullanıcı> <süre>");
...
let muterole = message.guild.roles.find(r => r.name === "Muted");
  ...
  //end of create role
  let mutetime = args[1];
  if(!mutetime) return message.reply("Doğru Kullanım: <"+prefix+">mute <kullanıcı> <süre> yada <"+prefix+">geçici-sustur <kullanıcı> <süre>");
